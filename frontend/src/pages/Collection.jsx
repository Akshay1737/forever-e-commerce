  ...
  return (
    <div className='flex flex-col  sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className="flex-1">
        <div className="flex justify-between text-between sm:text-2xl ml-4">
            <Title text1={"ALL"} text2={"COLLECTION"}/>
            {/*producrt sort */}
            <select onChange={(e) => setSortType(e.target.value)} name="" id="" className="border-gray-300 text-sm px-2">
        ...
        {/*Map products*/ }
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-4">
            {
